        ...
        <section id="hero" class="hero section light-background">
            ...
            <div class="container position-relative">
                ...
                <div class="content row gy-4">
                    <div class="col-lg-4 offset-lg-4 d-flex align-items-stretch">
                        <div class="why-box" data-aos="zoom-out" data-aos-delay="00">
                            <h3>Connection</h3>
                            ...
                            <input type="submit" name="connexion" value="connexion" class="cta-btn btn btn-white">
...
<section id="appointment" class="appointment section">
    ...
    <div class="container section-title" data-aos="fade-up">
        <h2>Rendez-vous</h2>
        <p>Prenez rendez-vous avec un de nos expert.</p>
    </div><!-- End Section Title -->
...
<section id="departments" class="departments section">
    ...
    <div class="container section-title" data-aos="fade-up">
        <h2>Départements</h2>
        <p>Tous les départements où nous avons des partenaires</p>
    </div><!-- End Section Title -->
        ...
        <div class="row">
            <div class="col-lg-3">
                <ul class="nav nav-tabs flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#departments-tab-5">Soin des yeux</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4">
                <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div>
                        <h3>Location</h3>
                        <p>5 Av. du Général de Gaulle, 93440 Dugny, New York, NY 535022</p>
                    </div>
                </div><!-- End Info Item -->
