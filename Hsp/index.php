...
<header id="header" class="header sticky-top">
    ...
    <div class="branding d-flex align-items-center">
        ...
        <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <a class="cta-btn d-none d-sm-block" href="Medilab/inscription.php">S'inscrire</a>
        </div>
    </div>
</header>
            ...
            <div class="content row gy-4">
                <div class="col-lg-6 offset-lg-3 d-flex align-items-stretch">
                    <div class="why-box p-4 rounded shadow-lg" data-aos="zoom-out" data-aos-delay="00">
                        ...
                        <a class="btn btn-link w-100 mt-3" href="Medilab/motdepasse_oublie.php">Mot de passe oublié ?</a>
                        <a class="btn btn-link w-100 mt-3" href="Medilab/inscription.php">Pas encore inscrit ? Inscrivez-vous ici</a>
